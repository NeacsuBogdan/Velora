...
- Seller workspace with scoped dashboard, listing visibility, seller-funded campaign controls, inventory updates, seller-order visibility, and approval-based merchant activation.
