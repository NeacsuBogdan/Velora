  ...
  return (
    <div className="grid gap-6">
      <Panel className="space-y-5">
        <Badge>Order history</Badge>
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            <h1 className="font-[var(--font-heading)] text-4xl font-bold tracking-tight">
              Track payment, fulfillment, and refund state.
            </h1>
            <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--muted)]">
              Orders are sourced from the live commerce engine and include
              status, payment state, totals, and discount snapshots captured at
              checkout time.
            </p>
          </div>
      ...
      {orders.length ? (
        ...
        <Panel>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-[var(--muted)]">
            Complete a checkout flow and this page will populate with paid,
            failed, and refunded order records as they move through the system.
          </p>
        </Panel>
      )}
    </div>
