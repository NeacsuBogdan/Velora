...
const navLinkClass =
  "inline-flex items-center rounded-full px-5 py-2.5 text-sm font-semibold text-white/74 transition-all hover:bg-white/10 hover:text-white";
const iconLinkClass =
    ...
    <header className="relative overflow-hidden rounded-[34px] border border-white/10 bg-[linear-gradient(180deg,rgba(44,18,92,0.95),rgba(19,10,47,0.94))] px-5 py-5 text-white shadow-[0_30px_90px_rgba(8,3,28,0.42)] backdrop-blur xl:px-8 xl:py-7">
      ...
      <div className="relative flex flex-col gap-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          ...
          <nav className="flex flex-wrap items-center gap-2 rounded-full border border-white/10 bg-white/6 p-2 backdrop-blur">
